...
# Begin Custom Build - Copying $(InputName) binaries to D:\Steam\steamapps\common\serious sam classic the second encounter\Bin
InputPath=.\Release\EntitiesMP.dll
InputName=EntitiesMP
SOURCE="$(InputPath)"

"G:\Steam\steamapps\common\serious sam classic the second encounter\Bin\$(InputName).dll" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	copy Release\$(InputName).dll "G:\Steam\steamapps\common\serious sam classic the second encounter\Bin\" >nul 
	copy Release\$(InputName).map "G:\Steam\steamapps\common\serious sam classic the second encounter\Bin\" >nul 
	copy Release\$(InputName).lib "G:\Steam\steamapps\common\serious sam classic the second encounter\Bin\" >nul 
